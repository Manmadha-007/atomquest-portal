    ...
    <footer className="border-t bg-slate-950 text-slate-50">
      <div className="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-[1fr_auto] lg:items-center">
          ...
          <div className="flex flex-col gap-3 sm:flex-row lg:flex-col mt-4">
            <Button asChild size="lg" className="h-12 bg-slate-50 px-8 min-w-[200px] text-slate-950 transition-all hover:bg-slate-800 hover:text-white hover:shadow-sm">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="h-12 border-white/20 bg-white/5 px-8 min-w-[200px] text-slate-50 hover:bg-white/10 hover:text-slate-50"
            >
        ...
        <div className="mt-16 grid gap-6 border-t border-white/10 pt-8 sm:mt-20 lg:grid-cols-[1fr_auto] lg:items-center">
