      ...
      {!dashboard.reviewCycle ? (
        <Card className="rounded-lg">
          <CardHeader>
            ...
            <CardDescription>
              Manager shared-goal propagation opens once a quarterly cycle is
              active.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Direct-report assignments are scoped to the active review cycle
          ...
          <div className="flex flex-col gap-3 rounded-lg border bg-card p-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                ...
                {dashboard.employeeOptions.length} active direct report
