...
function calculateZeroProgress(
  input: GoalProgressInput,
) {
  const startValue = toNumber(
    input.startValue,
...
export function calculateGoalProgress(
  ...
  switch (
    ...
    case "MIN":
      return calculateMinProgress(
        input,
      );

    case "ZERO":
      return calculateZeroProgress(
        input,
      );
